...
Actively maintained. 113 tools spanning all three UniFi APIs — complete for the
...
- **113 MCP tools** covering UniFi Network (65), Protect (45), and Site Manager (3) APIs, all under the `unifi_*` namespace
