...
Actively maintained. 91 tools spanning all three UniFi APIs — complete for the
...
- **91 MCP tools** covering UniFi Network (65), Protect (17), and Site Manager (9) APIs, all under the `unifi_*` namespace
