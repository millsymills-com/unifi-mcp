...
Actively maintained. 151 tools spanning all three UniFi APIs — complete for the
...
- **151 MCP tools** covering UniFi Network (97), Protect (45), and Site Manager (9) APIs, all under the `unifi_*` namespace
...
The 51 write tools are invisible until you explicitly set
